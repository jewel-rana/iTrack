              ...
              <div class="modal-dialog" role="document">  
                    <div class="modal-content">
                      ...
                      <div class="modal-body form">
                        ...
                        <div class="form-group">
                          <select v-model="form.packege" name="packege" placeholder="Billing Packege" 
                            class="form-control" :class="{ 'is-invalid': form.errors.has('packege') }" required v-for="packege in packeges" :key="packege.id">
                            <option v-bind="packege.id" value="">{{ packege.name }} {{ packege.price }}</option>
                          </select>
